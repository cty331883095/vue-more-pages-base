...
function genRouters ({
  ...
  const contexts = require.context('page@/index2/views', true, /([\s\S]*)?\/index\.vue$/, 'lazy')
  let routers = []
  ...
  return routers.map((router) => ({
    ...
    component: () => import(/* webpackChunkName:"index2-[request]",webpackPrefetch:0 */ `page@/index2/views/${router}/`)
  }))
}
